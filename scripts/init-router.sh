#!/bin/bash
mongos --configdb configReplSet/configsvr1:27017,configsvr2:27017,configsvr3:27017 --bind_ip_all --port 27017 &
sleep 30

# Ajouter les shards au routeur
mongosh --eval 'sh.addShard("shardReplSet1/shard1a:27017,shard1b:27017,shard1c:27017")'
mongosh --eval 'sh.addShard("shardReplSet2/shard2a:27017,shard2b:27017,shard2c:27017")'
